CREATE DATABASE  IF NOT EXISTS `studio` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */;
USE `studio`;
...
/*!50013 DEFINER=`luo`@`%` SQL SECURITY DEFINER */
...
-- Dump completed on 2018-08-05 21:02:58
