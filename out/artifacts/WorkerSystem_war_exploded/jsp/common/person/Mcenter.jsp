...
<head>
    ...
    <link rel="stylesheet" href="/css/common/person/mcenter.css">
    <script type="text/javascript" src="/js/common/person/Mcenter.js"></script>
</head>
<body>
<jsp:include page="/jsp/templete/top.jsp"></jsp:include>
<div class="center">
    <div class="base" <c:if test="${MCType == 1}">style="display: none;" </c:if>>
        <h3>基本信息</h3>
        <div class="form-group">
            ...
            <form action="/MemberCenter" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" oninput="SidCheck();" name="sid" class="form-control" id="csid" value="${userInfo.student_id}" placeholder="Your student id"><br>
                </div>
                <div class="form-group">
                    <label>姓名</label>
                ...
                <div class="form-group">
                    <label>用户等级</label>
                    <input type="text" name="grade" class="form-control" id="cgrade" value="${userInfo.grade}" disabled="disabled"><br>
                </div>
                <div class="form-group">
    ...
    <div class="passwd" <c:if test="${MCType == 1}">style="display: block;" </c:if>>
        <h3>密码修改</h3>
        <div class="form-group">
    ...
    <div class="change">
        <button id="changeMode" onclick="<c:if test='${MCType != 1}'>changeToPass();</c:if><c:if test='${MCType == 1}'>changeToBase();</c:if>" class="btn btn-dark"><c:if test="${MCType != 1}">更改密码</c:if><c:if test="${MCType == 1}">更改基本信息</c:if></button>
    </div>
</div>
